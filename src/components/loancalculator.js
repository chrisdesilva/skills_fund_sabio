    ...
    <div className="flex flex-col justify-center m-2 lg:m-10">
      <div className="shadow-xl rounded h-auto p-8 flex flex-col items-center">
        ...
        <p>
          ...
          metro's max for tuition and cost of living for the Full Stack Web
          Development programs, up to $9,995 for the AWS Cloud program tuition &
          $1,000 for cost of living, up to $15,000 for Cyber Security tuition
          and up to $6,000 for cost of living, or up to $13,500 for the
          Part-Time Full-Stack program tuition.
        </p>
        ...
        {minLoanAmt > loanAmount || loanAmount > loanInformation.maxLoanAmt ? (
          ...
          <button
            className="opacityApply uppercase bg-primary p-3 mb-4 w-48 rounded-full shadow-lg text-white"
